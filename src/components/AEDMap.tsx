            ...
            <Marker
              ...
              <Popup>
                <div>
                  ...
                  {aed.accessHours &&
                  <p className="text-sm">{aed.accessHours}</p>
                  }
                  ...
                  <div className="mt-3 pt-2 border-t border-gray-200">
                    ...
                    <div className="flex space-x-2">
                      <a
                        ...
                        className="flex items-center justify-center bg-blue-500 text-white text-xs px-2 py-1 rounded">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center bg-cyan-500 text-white text-xs px-2 py-1 rounded">
